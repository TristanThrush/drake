...
namespace drake {
    namespace examples {
		...
		const auto &trajectory_source = TrajectorySource<double>(*piecewise_polynomial_trajectory, 1);
            ...
            void PiecewisePolynomialReceiver::OutputCommand(const Context<double> &context,
