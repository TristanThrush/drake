...
using namespace drake::examples::qp_inverse_dynamics;

// Valkyrie resources.
const std::string valkyrie_model_path = drake::FindResourceOrThrow(
      "drake/examples/Valkyrie/urdf/urdf/"
      "valkyrie_A_sim_drake_one_neck_dof_wide_ankle_rom.urdf");
const std::string valkyrie_alias_group_path = drake::FindResourceOrThrow(
      "drake/examples/QPInverseDynamicsForHumanoids/"
      "config/valkyrie.alias_groups");
const std::string valkyrie_control_config_path = drake::FindResourceOrThrow(
      "drake/examples/QPInverseDynamicsForHumanoids/"
 ...
 */
class ValkyrieControllerDiagram : public systems::Diagram<double> {
 public:
  ValkyrieControllerDiagram(drake::lcm::DrakeLcm* lcm) {
